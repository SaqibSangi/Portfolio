...
export const bwThemeDark = {
    type: 'dark',
    primary: '#42A5F5', // A vibrant sky blue for primary elements
    primary400: '#64B5F6', // A lighter blue for hover or accents
    primary600: '#1E88E5', // A deeper blue for buttons or important elements
    primary80: '#42A5F5cc', // Semi-transparent primary blue for overlays
    primary50: '#42A5F580', // More transparency for subtle background highlights
    primary30: '#42A5F54d', //
    secondary: '#212121',
    secondary70: '#212121b3',
    secondary50: '#21212180',
    tertiary: '#F0F0F0', // Light gray for text or elements that need to stand out
    tertiary80: '#F0F0F0cc', // Slightly transparent light gray
    tertiary70: '#F0F0F0b3', // More transparency for soft, less dominant text
    tertiary50: '#F0F0F080', // Li
    aboutimg1: bwThemeboy,
    aboutimg2: bwThemegirl,
    eduimg: eduBlack,
    expimg: expBlack,
